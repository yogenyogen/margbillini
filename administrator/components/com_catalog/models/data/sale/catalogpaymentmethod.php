...
/**
 * Description of catalogpaymentmethod
 *
 * @author Gabriel
 */
class catalogpaymentmethod extends dbobject {
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return catalogpaymentmethod dbobject or false on failure.
     */
     ...
     *
     * @return boolean|catalogpaymentmethod Not false on success.
     */
     ...
     *
     * @return catalogpaymentmethod not false on success.
     */
