...
/**
 * Description of catalogsalestatelang
 *
 * @author Gabriel
 */
class catalogsalestatelang extends dbobject 
{
    public $Id=0;
    public $LangId=0;
    public $SaleStateId=0;
    public $Name="";
    public $Description="";
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return catalogsalestatelang dbobject or false on failure.
     */
     ...
     *
     * @return boolean|catalogsalestatelang Not false on success.
     */
     ...
     *
     * @return catalogsalestatelang not false on success.
     */
