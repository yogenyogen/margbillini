...
class catalogproductlang extends dbobject 
{
     ...
     * @return catalogproductlang dbobject or false on failure.
     ...
     * @return boolean|catalogproductlang Not false on success.
     ...
     * @return catalogproductlang not false on success.
     ...
     * Updata the object to the database
