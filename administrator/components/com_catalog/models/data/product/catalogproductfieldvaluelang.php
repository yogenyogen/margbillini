...
/**
 * Description of catalogproductfieldvaluelang
 *
 * @author Gabriel
 */
class catalogproductfieldvaluelang extends dbobject 
{
    
    public $Id=0;
    public $ProductFieldValueId=0;
    public $LangId=0;
    public $Value="";
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return catalogproductfieldvaluelang dbobject or false on failure.
     */
     ...
     *
     * @return boolean|catalogproductfieldvaluelang Not false on success.
     */
     ...
     *
     * @return catalogproductfieldvaluelang not false on success.
     */
