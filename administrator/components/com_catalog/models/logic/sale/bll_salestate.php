...
/**
 * Description of bll_salestate
 *
 * @author Gabriel
 */
class bll_salestate extends catalogsalestate {
     ...
     * an integer otherwise is going to be ignored
     * 
     * @return bll_salestate dbobject or false on failure.
     */
     ...
     *
     * @return boolean|bll_salestate Not false on success.
     */
    ...
    private function addLangValue($id)
    {
        ...
        $cfl=new catalogsalestatelang(0);
        $cfl->delete('SaleStateId',$id);
        //adding lang values
        $langs = languages::GetLanguages();
        foreach($langs as $lang)
        {
            $lang_suffix = "_".$lang->lang_id;
            $lv = new catalogsalestatelang(0);
            $lv->SaleStateId = $id;
     ...
     * @return catalogsalestatelang catalogsalestatelang value object.
     */
    public function getLanguageValue($LangId)
    {
        ...
        if($language->lang_id <= 0)
            return new catalogsalestatelang(-1);

        $langval  = new catalogsalestatelang(-1);
     ...
     * Get the language value
     * @param type $LangId id of the language
     * @return catalogsalestatelang array of catalogsalestatelang value object.
     */
