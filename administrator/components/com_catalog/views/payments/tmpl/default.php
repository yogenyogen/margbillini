...
<div id="j-main-container" class="span10"> 
    ...
    <h3>
        <?php  echo JText::_('COM_CATALOG_PAYMENT_METHODS')." ". JText::_('COM_CATALOG_MANAGER'); ?>
    </h3>
    ...
    <tr>
        ...
        <td> <?php echo $obj->getLanguageValue($LangId)->Name; ?></td>
         <td>
            ...
            <form method="POST" action="./index.php?option=com_catalog&view=payments&layout=edit">
...
?>
    ...
    <?php
    echo HtmlGenerator::GeneratePagination($ob->getObjectName(), './index.php?option=com_catalog&view=payments', $total, $lower_limit, $nelementsbypage);
    ?>
</div>