...
$login_redirect= base64_encode($this->params->get('login_redirect_url', $this->form->getValue('return'))); 
if(isset($_REQUEST['login_redirect_uri']))
{
    $login_redirect=  base64_encode($_REQUEST['login_redirect_uri']);
}
?>
<div class="login <?php echo $this->pageclass_sfx?>">
	<?php if ($this->params->get('show_page_heading')) : ?>
	<div class="page-header">
		<h3 class="page-header_border">
	...
	<form action="<?php echo JRoute::_('index.php?option=com_users&task=user.login'); ?>" method="post" class="form-horizontal">
		...
		<fieldset class="well">
			...
			<input type="hidden" name="return" value="<?php echo $login_redirect; ?>" />
